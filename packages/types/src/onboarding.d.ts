export type GoalType = 'cat_prep' | 'job_switch' | 'skill_upgrade' | 'freelancing' | 'investing' | 'fitness' | 'other';
export type Niche = 'cat_mba_prep' | 'coding_dsa' | 'personal_finance' | 'fitness_nutrition' | 'design_creative' | 'language_learning' | 'digital_marketing' | 'music_arts' | 'upsc_govt_exams' | 'mental_wellness' | 'photography' | 'science_research' | 'real_estate' | 'writing_content' | 'ai_data_science' | 'gaming_esports' | 'cooking_food' | 'interview_prep' | 'ayurveda_yoga' | 'startup_product';
