  ...
  return (
    <div className="w-full space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="font-display text-3xl font-bold tracking-tight text-foreground">Join Creonex</h1>
      ...
      <p className="text-center text-xs text-muted-foreground/80 mt-4 px-6 leading-relaxed">
