  ...
  return (
    <div className="w-full space-y-8">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-muted-foreground">Sign in to your Creonex account to continue</p>
      </div>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-background/80 backdrop-blur-md px-3 py-1 font-medium text-muted-foreground rounded-full border border-border/50">Or continue with email</span>
        </div>
      </div>
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href="/sign-up" className="font-medium text-foreground transition-colors hover:text-primary hover:underline underline-offset-4">
          Create one
        </Link>
      </p>
    </div>
