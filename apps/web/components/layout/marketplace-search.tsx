    ...
    <Suspense
      fallback={
        <div className={cn('relative', className)}>
          <FontAwesomeIcon
            icon={faMagnifyingGlass}
            className="pointer-events-none absolute left-4 top-1/2 size-3.5 -translate-y-1/2 text-muted-foreground/50"
          />
          <input
            type="text"
            disabled
            placeholder={placeholder}
            aria-label="Search creators or offerings"
            className="h-9.5 w-full rounded-full border border-border bg-muted/50 pl-10 pr-9 text-sm text-foreground shadow-sm placeholder:text-muted-foreground/50"
          />
        </div>
      }
    >
